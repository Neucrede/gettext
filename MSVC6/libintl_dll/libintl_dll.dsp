...
!MESSAGE 
!MESSAGE NMAKE /f "libintl_dll.mak" CFG="libintl_dll - Win32 Release"
!MESSAGE 
...
# ADD CPP /nologo /MD /W3 /GX /O2 /I ".\..\..\MSVC6" /I ".\..\..\source\gettext-runtime" /FI"vc6.h" /D "BUILDING_LIBINTL" /D "BUILDING_DLL" /D "IN_LIBINTL" /D ENABLE_RELOCATABLE=1 /D "IN_LIBRARY" /D "NO_XMALLOC" /D set_relocation_prefix=libintl_set_relocation_prefix /D relocate=libintl_relocate /D DEPENDS_ON_LIBICONV=1 /D "HAVE_CONFIG_H" /FR /FD /c
